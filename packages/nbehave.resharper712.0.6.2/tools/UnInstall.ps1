...
Write-Host "If you want to uninstall the plugin you have to manually delete the folder '$userProfileDir\AppData\Local\JetBrains\ReSharper\v7.1\Plugins\NBehave'" -BackgroundColor Black -ForegroundColor Yellow
